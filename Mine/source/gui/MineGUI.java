...
public class MineGUI extends JPanel implements ActionListener {
	...
	public MineGUI(Level lv) {
		// level���� ���� ROWS, COLS, MINE ���� �����ְ� �װ� �̿��� �����г��� �����Ѵ�.
		if (lv == Level.ROW) {
	...
	public int[][] configureMine() { 		// ���ڸ� �������� ��ġ�ϰ� �������� ���� ������ ���.
		int count = 0;
	...
	public boolean validRange(int r, int c) { 		// �Ѿ�� ��ǥ���� ������ ������� ���.(true, false)
	...
	public void updateScore() {
		String name = JOptionPane.showInputDialog( this, "�ְ����� �����ϼ̽��ϴ�. \n �̸��� �Է��� �ּ���", "����~!!", JOptionPane.OK_CANCEL_OPTION );
		String text = null;
		String score = null;
		try {
			...
			score = temp[0] + "�� " + temp[1] + "��׷����̼�~��.������~����";
      		JOptionPane.showMessageDialog( this, score, "End", JOptionPane.OK_OPTION , new ImageIcon("new4.gif") );
			} catch (IOException ex) { System.err.println("update���� �߻�");}
	}
	/* timer action method */
	public void actionPerformed(ActionEvent e) {
		// time�� �ڸ������� ���Ѵ��� �� Lebel�� image Icon setting
